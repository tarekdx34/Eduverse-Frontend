...
export class AiSummary {
  ...
  @Column({
    type: 'enum',
    enum: ['brief', 'detailed', 'bullet_points', 'key_concepts'],
    default: 'detailed',
  })
  summaryType: string;
...
- **Student**: AIFeatures.tsx, AINotes.tsx, AIFeatures/ (subfolder) _(active as `ai` tab)_
- **TA**: AIAssistantPage.tsx _(active as `ai-assistant` tab)_
- ~~**Instructor**: AIToolsPage.tsx, ai-features/ (subfolder)~~ _(Removed from Instructor sidebar — task I10)_
- ~~**Admin**: AIInsightsPage.tsx~~ _(Not in Admin sidebar — deleted)_
- ~~**IT Admin**: AIManagementPage.tsx~~ _(Not in IT Admin sidebar — deleted)_
