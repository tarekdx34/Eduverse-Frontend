...
export class Grade {
  ...
  @Column({
    type: 'enum',
    enum: ['assignment', 'quiz', 'lab', 'midterm', 'final', 'participation', 'project', 'other'],
  })
  gradeType: string;
...
export class AttendanceRecord {
  ...
  @Column({
    type: 'enum',
    enum: ['manual', 'qr_code', 'face_recognition', 'auto'],
    default: 'manual',
  })
...
- ~~**TA**: AttendancePage.tsx~~ _(Removed from TA sidebar — task T7; attendance now integrated into course tab per T4)_
- ~~**Admin**: AttendanceManagementPage.tsx~~ _(Not in Admin sidebar — deleted)_
...
- ~~**Instructor**: LabsPage.tsx~~ _(Removed from Instructor sidebar — task I11)_
