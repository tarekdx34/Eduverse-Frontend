...
- ~~**Admin**: AdminNotificationsPage.tsx~~ _(Not in Admin sidebar — deleted)_
...
- **All Dashboards**: MessagingChat.tsx _(shared Chat tab active in all 5 dashboards)_
- **Admin**: CommunicationPage.tsx _(active in Admin sidebar as `communication` tab)_
- ~~**Instructor**: CommunicationPage.tsx~~ _(Not in Instructor sidebar — deleted; Chat tab used instead)_
- ~~**TA**: CommunicationPage.tsx~~ _(Removed from TA sidebar — task T11; Chat tab used instead)_
