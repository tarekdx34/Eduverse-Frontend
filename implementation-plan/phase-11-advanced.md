...
- ~~**TA**: OfficeHoursPage.tsx~~ _(Removed from TA sidebar — task T8)_
...
- ~~**Admin**: GlobalSearchPage.tsx~~ _(Not in Admin sidebar — deleted)_
- ~~**Instructor**: GlobalSearchPage.tsx~~ _(Removed from Instructor sidebar — task I16)_
- **Student**: GlobalSearch.tsx _(sub-component, not a standalone sidebar tab)_
...
- ~~**Admin**: FeedbackSupportPage.tsx~~ _(Not in Admin sidebar — deleted)_
- **IT Admin**: FeedbackSupportPage.tsx ✅ _(Active in IT Admin sidebar as `feedback` tab)_
