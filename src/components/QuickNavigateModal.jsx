...
const TAREK_PAGES = [
  {
    ...
    description:
      'Added: Quizzes, Analytics, Office Hours, Notifications, AI Assistant, Lab Resources tabs',
    icon: Zap,
  },
  {
    path: '/tadashboard',
  ...
  },
  {
    ...
    description:
      'Added Quiz Center tab with full QuizTaking component (selection, active quiz, results)',
    icon: Zap,
  },
  {
    path: '/admindashboard',
    ...
    description:
      'Renamed User Management → Student Management with new StudentManagementPage component',
    icon: Zap,
  },
  {
    path: '/admindashboard',
  ...
  },
  {
    ...
    description:
      'AIQuestionEditor and MessagingChat now have explicit isDark props and improved dark mode styling',
    icon: Zap,
  },
  {
    path: '/instructordashboard',
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogContent className="sm:max-w-md">
        ...
        <p className="text-sm text-muted-foreground mb-4">
          Press <kbd className="px-1.5 py-0.5 rounded bg-muted text-xs font-mono">Ctrl+Shift+E</kbd>{' '}
        ...
        <div className="grid gap-2 max-h-[60vh] overflow-y-auto pr-2">
          ...
          <p className="text-xs text-muted-foreground mb-2">
            Track the pages you are redesigning here (compare before/after).
          </p>
              ...
              return (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    {page.description ? (
                      <p className="text-xs text-primary/80 mt-1 whitespace-pre-line">
                        {page.description}
                      </p>
                    ) : (
                      <p className="text-xs text-muted-foreground truncate">{page.path}</p>
          ...
          <p className="text-xs text-muted-foreground mb-2">
            Track what Tarek added in the finalize branch.
          </p>
              ...
              return (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <span className="font-medium text-foreground block">{page.label}</span>
                    {page.description ? (
                      <p className="text-xs text-amber-600/80 mt-1 whitespace-pre-line">
                        {page.description}
                      </p>
                    ) : (
                      <p className="text-xs text-muted-foreground truncate">{page.path}</p>
