            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li>
                <a href="#roles" className="hover:text-foreground transition-colors">
                  {t('User Roles', 'أدوار المستخدم')}
                </a>
              </li>
              <li>
                <a href="#gamification" className="hover:text-foreground transition-colors">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-sm text-muted-foreground">
              {t(
                ...
                '© 2024 إيدوفيرس. جميع الح��وق محفوظة.'
              )}
            </p>
            <div className="flex space-x-6 text-sm text-muted-foreground">
              ...
              <a href="#" className="hover:text-foreground transition-colors">
                {t('Cookie Policy', 'سياسة ملفات تعريف الارتباط')}
              </a>
            </div>
          </div>
        </div>
