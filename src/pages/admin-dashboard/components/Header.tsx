...
export function Header({ userName = 'System Administrator', onProfileClick }: HeaderProps) {
  ...
  return (
    ...
    >
      ...
      <div className="relative pointer-events-auto" ref={dropdownRef}>
        ...
        >
          <div className="w-9 h-9 bg-gradient-to-br from-red-500 to-orange-500 rounded-full cursor-pointer hover:opacity-80 transition-opacity flex items-center justify-center text-white text-sm font-semibold">
            SA
          </div>
        </button>
          ...
          >
            ...
            <div className="px-2 py-2">
              ...
              <button
                ...
                className={`w-full flex items-center gap-3 px-3 py-2 rounded-lg transition-colors text-red-500 hover:bg-red-50 ${isDark ? 'hover:bg-red-900/20' : ''}`}
              >
