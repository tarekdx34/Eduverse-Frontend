...
> = {
  'ai-assistant': {
    ...
    description:
      'AI features are still not implemented for Live Mode. The mock experience remains unchanged.',
  },
};
  ...
  return (
    ...
    >
      ...
      >
        ...
        {activeTab === 'grading' &&
          (isMockMode ? (
            <GradingPage submissions={mockAllSubmissions as any} />
          ) : (
            <GradingPage
        ...
        {activeTab === 'discussion' && (
          <DiscussionPage
            userRole="ta"
            userName={currentUserName}
            disableDeleteReason={!isMockMode ? DISCUSSION_DELETE_DISABLED_REASON : undefined}
          />
        )}
