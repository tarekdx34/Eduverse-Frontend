...
export const SUBMISSIONS: Record<string, any[]> = {
  lab1: [
    ...
    },
    {
      ...
      files: [
        { id: 'f3', name: 'lab1_solution.py', size: '5.2 KB' },
      ],
      status: 'graded',
      grade: 88,
    ...
    },
    {
      ...
      files: [
        { id: 'f4', name: 'exercises.zip', size: '12.5 KB' },
      ],
      status: 'graded',
      grade: 92,
      feedback: 'Well done!',
  ...
  lab2: [
    {
      ...
      files: [
        { id: 'f5', name: 'control_structures.py', size: '4.8 KB' },
      ],
      status: 'submitted',
      grade: null,
      feedback: null,
    },
    {
      ...
      files: [
        { id: 'f6', name: 'lab2_solution.py', size: '6.1 KB' },
      ],
      status: 'submitted',
      grade: null,
      feedback: null,
