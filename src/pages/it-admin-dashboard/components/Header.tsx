...
export function Header({ userName = 'IT Administrator', onProfileClick }: HeaderProps) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className={`absolute top-1 ${isRTL ? 'left-1' : 'right-1'} w-2 h-2 bg-blue-500 rounded-full`}
        />
      </button>
